...
#include <SFML/Window.hpp>                         // Include the SFML window header for creating windows
#include <SFML/System.hpp>                         // Include the SFML system header for time-related functions
#include <SFML/Audio.hpp>                          // Include the SFML audio header for audio
// #include <SFML/Network.hpp>                        // Include the SFML network header for network
// #include <SFML/OpenGL.hpp>                         // Include the SFML OpenGL header for OpenGL
#include <SFML/Audio/SoundBuffer.hpp>              // Include the SFML audio header for audio
#include <SFML/Audio/Sound.hpp>                    // Include the SFML audio header for audio
#include <SFML/Graphics/Font.hpp>                  // Include the SFML graphics header for drawing shapes and text
...
int main() {
    ...
    while (window.isOpen()) {
        ...
        // Write output to audio destination
    }
